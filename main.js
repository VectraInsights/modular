// App de PC — janela Electron do Planejador de Cômodos (2D + 3D)
...
const menu = Menu.buildFromTemplate([
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: 'Sobre', click: () => dialog.showMessageBox(win, { type: 'info', title: 'Planejador de Cômodos', message: 'Planejador de Cômodos 1.0 — digite as medidas e veja a planta 2D + 3D.' }) }
    ]
  }
]);
